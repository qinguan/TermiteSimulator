...
public class GraphDisplay extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		SimulatorResultJLabel.setFont(new java.awt.Font("Î¢ÈíÑÅºÚ", 2, 14));
		...
		widthJLabel.setFont(new java.awt.Font("Î¢ÈíÑÅºÚ", 2, 12));
		...
		heightJLabel.setFont(new java.awt.Font("Î¢ÈíÑÅºÚ", 2, 12));
		...
		soldierTermiteNumberJLabel.setFont(new java.awt.Font("Î¢ÈíÑÅºÚ", 2, 12));
		...
		workerTermiteNumberJLabel.setFont(new java.awt.Font("Î¢ÈíÑÅºÚ", 2, 12));
		...
		chipNumberJLabel.setFont(new java.awt.Font("Î¢ÈíÑÅºÚ", 2, 12));
		...
		loopNumberJLabel.setFont(new java.awt.Font("Î¢ÈíÑÅºÚ", 2, 12));
		...
		timeSpanJLabel.setFont(new java.awt.Font("Î¢ÈíÑÅºÚ", 2, 12));
		...
		jLabel1.setFont(new java.awt.Font("Î¢ÈíÑÅºÚ", 2, 14));
		jLabel1.setText("Simulator Text Result (chip:soldier:worker/withChip)");

		SimulatorSettingJLabel.setFont(new java.awt.Font("Î¢ÈíÑÅºÚ", 2, 14));
	...
	private void GetUserSettingParam(java.awt.event.ActionEvent evt) {
		...
		for (int i = 0; i < simulatorAttribute.getLoopNumber(); i++) {
			...
			//last 50 results
			//¹¤ÒÏÊýÄ¿Ð¡ÓÚÄ¾Æ¬ÊýÄ¿_stable state 1
			...
			//¹¤ÒÏÊýÄ¿´óÓÚÄ¾Æ¬ÊýÄ¿_stable state 2
